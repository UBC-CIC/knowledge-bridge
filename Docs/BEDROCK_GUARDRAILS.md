...
This document explains the Bedrock Guardrails implementation integrated into the Knowledge Bridge. It covers how guardrails are created in CDK, configured, and enforced at runtime in the text generation Lambda, and provides tips for testing, monitoring, and troubleshooting.

## Introduction

### What is Amazon Bedrock?
Amazon Bedrock is a fully managed service that provides access to foundation models (LLMs) from leading AI providers through a single API. In this project, Amazon Bedrock powers the Knowledge Bridge, helping staff and CIOs query SharePoint content through conversational AI.
**Learn more:** https://docs.aws.amazon.com/bedrock/

### How this project uses LLMs
The Knowledge Bridge uses Bedrock foundation models to:
...
- Stay on-topic for organizational knowledge base use cases
...
const guardrailConfig = {
  ...
  blockedInputMessaging: "Sorry, I can't help with that. I'm the Knowledge Bridge — I'm here to help you find information from your organization's SharePoint content.",
};
...
- **Bedrock LLM / Foundation model:** Pretrained large language models offered through Amazon Bedrock, such as Claude Haiku or Claude Sonnet. These are the models the Knowledge Bridge invokes to generate responses grounded in SharePoint content.
